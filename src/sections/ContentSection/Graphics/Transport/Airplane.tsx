const Airplane = () => (
  <svg viewBox="0 -80 515 300" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      id="flyroute"
      d="M514.5 165C434 42 218.9 -130.2 2.5 165"
      stroke="#129cbb"
      strokeWidth="4"
    />
    <path
      id="flyroute1"
      d="M775 169.5C726 88.3334 606.8 -59.0834 474 30.5167C422.891 65 396.5 117 286.5 82.5C253.862 72.2637 74 16.5 2.5 127"
      stroke="#e7cd70"
      strokeWidth="4"
    />
    <path
      id="flyroute2"
      d="M625 140.317C595.667 107.484 515.5 54.8171 429.5 106.817C322 171.817 298.421 -48.4521 403 23.9993C562.5 134.499 316.028 185.314 174 23.9995C133.5 -22 33 13.5 2 47.817"
      stroke="#22ba8f"
      strokeWidth="4"
    />
    <path
      id="flyroute3"
      d="M631.5 225.731C602.167 192.897 453.421 229.233 345.5 183.232C230 134 255.5 -22.5002 412 6.00001C659.8 51.1268 445.529 281.288 275.5 149.817C186.5 81 33 115.5 2 149.817"
      stroke="#df9fb9"
      strokeWidth="4"
    />

    <g id="plane" transform="rotate(40) scale(1.4)">
      <g id="color">
        <path
          fill="#9B9B9A"
